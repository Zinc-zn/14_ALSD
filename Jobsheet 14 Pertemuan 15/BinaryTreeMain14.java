public class BinaryTreeMain14 {
    public static void main(String[] args) {
        ...
        // bst.add(new Mahasiswa14("244160131", "Devi", "A", 3.71));
        ...
        // System.out.println("\nPengahapusan data mahasis wa");
        // bst.delete(3.57);
        // System.out.println("\nDaftar semua mahasiswa setelah penghapusan 1 mahasiswa (in order traversal):");
        // bst.traverseInOrder(bst.root);

        bst.addRekursif(new Mahasiswa14("123", "Ali", "A", 3.57));
        bst.addRekursif(new Mahasiswa14("124", "Budi", "B", 3.85));

        bst.cariMinIPK();
        bst.cariMaxIPK();

        bst.tampilMahasiswaPKdiAtasBatas(3.50);
